package it.alberto.wodapp.Utility.util
...
import it.alberto.wodapp.Utility.AppConstants
import it.alberto.wodapp.Utility.TimerActivity
import it.alberto.wodapp.Utility.TimerNotificationActionReceiver
    ...
    companion object {
        ...
        fun showTimerExpired(context: Context) {
            ...
            nBuilder.setContentTitle("Timer Expired!")
                ...
                .addAction(R.drawable.ic_baseline_play_arrow, "Start", startPendingIntent)
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long) {
            ...
            nBuilder.setContentTitle("Timer is Running.")
                ...
                .addAction(R.drawable.ic_baseline_pause, "Pause", pausePendingIntent)
        ...
        fun showTimerPaused(context: Context) {
            ...
            nBuilder.setContentTitle("Timer is paused.")
                ...
                .setContentIntent(getPendingIntentWithStack(context, TimerActivity::class.java))
                .setOngoing(true)
                .addAction(R.drawable.ic_baseline_play_arrow, "Resume", resumePendingIntent)
